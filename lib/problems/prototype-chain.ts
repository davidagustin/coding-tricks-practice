  ...
  testCases: [
    {
      input: [],
      expectedOutput: 'red',
      description: 'Shape.getColor returns correct color',
    },
    {
      input: [],
      expectedOutput: 'A red shape',
      description: 'Shape.describe returns correct description',
    },
    {
      input: [],
      expectedOutput: 20,
    ...
    },
    {
      input: [],
      expectedOutput: true,
      description: 'Rectangle instanceof Shape is true',
    },
    {
      input: [],
      expectedOutput: 'Hello, World',
      description: 'Object.create greeter works correctly',
    },
    {
      input: [],
      expectedOutput: 3,
