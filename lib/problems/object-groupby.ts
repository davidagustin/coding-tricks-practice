  ...
  testCases: [
    {
      ...
      description: 'groupByProperty - groups objects by property',
    },
    {
      input: [[5, 12, 23, 8, 31]],
      expectedOutput: { '0-9': [5, 8], '10-19': [12], '20-29': [23], '30-39': [31] },
      description: 'groupByRange - groups numbers into ranges',
    },
    {
      input: [['Apple', 'Banana', 'Avocado', 'Cherry']],
      expectedOutput: { A: ['Apple', 'Avocado'], B: ['Banana'], C: ['Cherry'] },
      description: 'groupByFirstLetter - groups by first letter',
    },
    {
      input: [[{ a: 1 }, { a: 2 }, { a: 1 }], (item: { a: number }) => item.a],
      expectedOutput: { 1: [{ a: 1 }, { a: 1 }], 2: [{ a: 2 }] },
      description: 'groupByPolyfill - replicates Object.groupBy behavior',
    },
  ],
  hints: [
