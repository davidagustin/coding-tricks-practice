...
function intersectionMany(...arrays) {
  ...
  testCases: [
    ...
    },
    {
      input: [[1, 2, 3], [2, 3, 4]],
      expectedOutput: [1, 4],
      description: 'symmetricDifference returns exclusive elements',
    },
    {
      input: [[1, 2, 3], [3, 4, 5]],
    ...
    },
    {
      input: [[2, 3], [1, 2, 3, 4]],
      expectedOutput: true,
      description: 'isSubset returns true when subset is valid',
    },
    {
      input: [[2, 5], [1, 2, 3, 4]],
      expectedOutput: false,
      description: 'isSubset returns false when element missing',
    },
  ],
  hints: [
