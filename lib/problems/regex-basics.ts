...
console.log(countWords('Hello world'));   // 2`,
  solution: `function isOnlyLetters(str) {
  ...
  testCases: [
    {
      input: ['Hello'],
      expectedOutput: true,
      description: 'isOnlyLetters with letters only',
    },
    {
      input: ['Hello123'],
      expectedOutput: false,
      description: 'isOnlyLetters with numbers',
    },
    {
      input: ['I have 3 cats and 2 dogs'],
      expectedOutput: ['3', '2'],
      description: 'extractNumbers finds all numbers',
    },
    {
      input: ['#FFF'],
      expectedOutput: true,
      description: 'isValidHexColor with 3-digit hex',
    },
    {
      input: ['#FFFFFF'],
      expectedOutput: true,
      description: 'isValidHexColor with 6-digit hex',
    },
    {
      input: ['Hello world'],
      expectedOutput: 2,
      description: 'countWords counts correctly',
    },
  ],
  hints: [
