  ...
  testCases: [
    {
      ...
      description: 'getSortedCopy returns sorted array',
    },
    {
      input: [[1, 2, 3, 4]],
    ...
    },
    {
      ...
      description: 'removeAtIndex removes element at index',
    },
    {
      input: [['a', 'd'], 1, 'b', 'c'],
      expectedOutput: ['a', 'b', 'c', 'd'],
      description: 'insertAtIndex inserts elements at index',
    },
    {
      input: [[1, 2, 3], 1, 'X'],
      expectedOutput: [1, 'X', 3],
      description: 'replaceAtIndex replaces element at index',
    },
    {
      input: [[1, 5, 3, 2, 4]],
      expectedOutput: [5, 4, 3, 2, 1],
      description: 'sortDescending sorts in descending order',
    },
  ],
  hints: [
