  ...
  testCases: [
    {
      ...
      expectedOutput: 'NYC',
      description: 'getUserCity with complete address',
    },
    {
      input: [{ address: {} }],
      expectedOutput: undefined,
      description: 'getUserCity with missing city',
    },
    {
      input: [null],
      expectedOutput: undefined,
      description: 'getUserCity with null user',
    },
    {
      input: [{ items: [{ name: 'Widget' }] }],
      expectedOutput: 'Widget',
      description: 'getFirstItemName with items',
    },
    {
      input: [{ items: [] }],
      expectedOutput: 'No items',
      description: 'getFirstItemName with empty array',
    },
    {
      input: [{}],
      expectedOutput: 'No items',
      description: 'getFirstItemName with no items property',
    },
  ],
  hints: [
