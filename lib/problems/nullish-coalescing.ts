  ...
  testCases: [
    {
      ...
      description: 'getConfigWithDefaults preserves valid falsy values',
    },
    {
      input: [{}],
      expectedOutput: { port: 3000, timeout: 5000, debug: false, name: 'app' },
      description: 'getConfigWithDefaults uses defaults for missing values',
    },
    {
      input: [0, 100],
      expectedOutput: 0,
      description: 'getValue returns 0 (not null/undefined)',
    },
    {
      input: [null, 100],
      expectedOutput: 100,
    ...
    },
    {
      input: [null],
      expectedOutput: 1,
      description: 'incrementCounter starts at 0 for null',
    },
    {
      input: [5],
      expectedOutput: 6,
      description: 'incrementCounter increments existing value',
    },
  ],
  hints: [
